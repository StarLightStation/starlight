...
public class ProductDAO {
   ...
   = "SELECT P.PNUM,P.PNAME,P.PPRICE,P.PIMAGE,P.PCNT,P.PCATEGORY,P.PALCOHOL,P.PSWEET,P.PSOUR,P.PSPARKLE,P.PIMAGEDETAIL, ROUND(AVG(B.BSTAR),1) AS PSTARAVG, COUNT(B.BSTAR) AS PSTARCNT"
