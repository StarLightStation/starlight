...
public class MyPageMemberController {
    ...
    @RequestMapping(value = "/deleteMember.do", method = RequestMethod.GET)    //	매핑
     ...
     * 리턴 값: model : mdata(mVO) / 세션 : X
     * 기능: 회원정보 보기 ( member.jsp 이동 )
     */
    ...
    public String updateMember(MemberVO mVO, HttpSession session, Model model) {
        ...
        System.out.println("log : tmpmPW : " + mVO.getTmpMpw());
        System.out.println("log : tmpmName : " + mVO.getTmpMname());

        boolean flag = memberService.update(mVO);    //	mID	//	회원의 정보 변경	//	구글 로그인 , 주주 로그인 시로 나뉨
        ...
        return "sweetAlert.jsp";    //	정보 변경 후 로그아웃 진행
        }
