...
<c:if test="${empty mID}">
    <button class="sub-openBtn" onclick="window.location.href='login.do'" style="border: none; border-radius: 5px;">
        지금 신청하기
    </button>
</c:if>
    ...
    <div class="modal hidden">
        ...
        <div class="modalBox">
            ...
            <div class="checkbox-all">
                ...
                <form action="subscription.do" method="post">
                    <div class="checkbox-container">
                        <input type="hidden" name="mID" value="${mID}">
                        <input type="hidden" name="cartFlag" value="subscription">
