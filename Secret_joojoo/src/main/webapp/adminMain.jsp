                    ...
                    <a class="dropdown-item" href="#">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                                <span class="fw-semibold d-block">ADMIN</span> <small class="text-muted">ADMIN</small>
                            </div>
                        </div>
                    </a>
                </li>
                    ...
                    <div class="d-flex align-items-end row">
                        ...
                        <div class="col-sm-5 text-center text-sm-left">
                            <div class="card-body pb-0 px-0 px-md-4">
                                <img
                                        src="admin/assets/img/illustrations/man-with-laptop-light.png" height="140"
                    ...
                    <div class="col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <fmt:formatNumber var="todayProductprice" type="number"
                                                  value="${ todayProductprice.total_price}"/>
                    ...
                    <div class="col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <fmt:formatNumber var="todaySubsprice" type="number"
                                                  value="${ todaySubsprice.total_price}"/>
