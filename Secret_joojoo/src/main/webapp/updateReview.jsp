                ...
                <c:forEach var="v" items="${bdatas}"> <!-- 보드 배열리스트 가져오기 -->
                    ...
                    <div class="review-card">
                     ...
                     <div class="review-card-btn"> 
	                    ...
	                    <h1 class="btn">삭제</h1>
	                     <!-- 두 번째 Modal을 여는 클래스 -->
	                    <h1 class="btn" style="margin-left: 16px;">수정</h1>
                    </div>
                    ...
                    <div class="modal">
                        <div class="modal-content">
                            ...
                            <div class="button-container">
                                <a href="deleteReview.do?bNum=${bNum}" class="button true">예</a>
                                <button class="false" id="closeButton">아니오</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="rating_box">
                                <form action="updateReview.do?bNum=${bNum}" method="post">
                                    <input type="hidden" name="mID" value="${mID}">
                                    <input type="hidden" name="mName" value="${mName}">
                                    <input type="hidden" name="pNum" value="${pNum}">
                                    <span class="rating">★★★★★
                                    <span class="rating_star">★★★★★</span>
                                    <input type="range" name="bStar" value="${bStar}" step="0.5" min="0" max="5">
                                    </span>
                                    <br>
                                    <textarea
                                            id="myTextarea"
                                            ...
                                            rows="10"
                                            cols="120"
                                            placeholder="리뷰 내용을 입력해 주세요.">${bContent}</textarea>
                                    <br><br>
